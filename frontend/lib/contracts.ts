// Contract addresses - Deployed on Sepolia Testnet (CORRECTED - December 15, 2025)
...
// WhitelistManager ABI - Only the functions we need for admin operations
